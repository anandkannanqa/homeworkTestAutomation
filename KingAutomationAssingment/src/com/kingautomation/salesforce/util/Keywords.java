package com.kingautomation.salesforce.util;
...
public class Keywords {
	...
	private Keywords() {
		...
		try{
			...
			OR = new Properties();
			FileInputStream fs = new FileInputStream(System.getProperty("user.dir")+"//src//com//kingautomation//salesforce//config//OR.properties");
			OR.load(fs);
			//init env
			ENV=new Properties();
			...
			fs = new FileInputStream(System.getProperty("user.dir")+"//src//com//kingautomation//salesforce//config//"+fileName);
			ENV.load(fs);
	...
	public void openBrowser(String browserName) throws MalformedURLException{
		...
		//	DesiredCapabilities capability = DesiredCapabilities.firefox();
			...
			System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir")+"//src//com//kingautomation//salesforce//drivers//chromedriver.exe");
		//	DesiredCapabilities capability = DesiredCapabilities.chrome();
			...
			System.setProperty("webdriver.ie.driver", System.getProperty("user.dir")+"//src//com//kingautomation//salesforce//drivers//IEDriverServer.exe");
			if(ieCounter==0)
	...
	/**
	 * Wait until the title is available for the SUT
	 * @param xpath
	 */
	public void waitUntilTitleIs(String xpath) {

		wait.until(ExpectedConditions.titleIs(OR.getProperty(xpath)));

	}
	
	/**
	 * Switch to the new window or pop up if available
	 * @param xpath
	 * 
	 */
	public void switchIfSubWindowAvailable() {
